 ...
 * additional information such as the relationships between
 * data (happens before/after).
 * These can also be used to disable certain checking in cases
 * where TSan is throwing warnings that we wish to suppress.
 *

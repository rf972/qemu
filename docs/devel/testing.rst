...
the warning files.  TSan warnings are placed in files located at build/tsan/

To modify the TSAN_OPTIONS environment variable
We recommend using DEBUG=1 to allow review of the warnings generated by TSan.
